...
const SliderInicio = forwardRef(({id},externalRef) => {
    ...
    return(
        <section id={id} ref={externalRef} className="sliderInicio"
            onTouchStart={handleTouchStart}
            onTouchEnd={handleTouchEnd}
        >
            <div className="sliderInicio-container">
...
function SliderInicio(){
    ...
    return(
        <section id="sliderInicio" className="sliderInicio"
            onTouchStart={handleTouchStart}
            onTouchEnd={handleTouchEnd}
        >
            <div className="sliderInicio-botonesBox">
